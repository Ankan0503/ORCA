...
interface OrcaAlertsHeaderProps {
  onBackClick: () => void;
  currentLanguage?: LanguageOption;
  locationName?: string;
}

export const OrcaAlertsHeader: React.FC<OrcaAlertsHeaderProps> = ({
  onBackClick,
  currentLanguage,
  ...
  return (
    <header
      ...
      id="orca-alerts-header"
      aria-label="Alerts navigation header"
    >

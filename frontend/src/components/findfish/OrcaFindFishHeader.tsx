...
interface OrcaFindFishHeaderProps {
  onBackClick: () => void;
...
export const OrcaFindFishHeader: React.FC<OrcaFindFishHeaderProps> = ({
  onBackClick,
  currentLanguage,
  ...
  return (
    <header
      ...
      id="orca-find-fish-header"
      aria-label="Find fish navigation header"
    >

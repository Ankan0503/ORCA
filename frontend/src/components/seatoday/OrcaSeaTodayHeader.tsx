...
interface OrcaSeaTodayHeaderProps {
  onBackClick: () => void;
...
export const OrcaSeaTodayHeader: React.FC<OrcaSeaTodayHeaderProps> = ({
  onBackClick,
  currentLanguage,
  ...
  return (
    <header
      className="relative z-20 w-full flex items-center justify-between gap-2.5 pt-2 min-[390px]:pt-3 sm:pt-4 pb-1 sm:pb-2 select-none"
      id="orca-sea-today-header"
      aria-label="Sea today navigation header"
    >
